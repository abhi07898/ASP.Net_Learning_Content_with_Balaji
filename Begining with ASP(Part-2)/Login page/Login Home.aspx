<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Login Home.aspx.vb" Inherits="Login_Home" %>
...
<body>
    ...
    <div style="background-color:yellow; height:811px; width:100%" >
        ...
        <div style="background-color:palevioletred;color:yellow; margin-left: 542px;" class="auto-style2">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnlogin" runat="server" Height="51px" style="font-size: xx-large" Text="Login" Width="157px" />
&nbsp;&nbsp;&nbsp;&nbsp;
           <a href="Login%20Register.aspx"><asp:Button ID="btnregister" runat="server" Height="51px" style="font-size: xx-large" Text="Register" Width="181px" /></a>
            <br />
            </strong></span>
